...
{
    public void addition(int a , int b)                                                            //method to calculate Addition
    {
        System.out.println("Addition of a and b is : " +(a+b));
    }
    public void subtraction(int a , int b)                                                        //method to calculate subtraction
    {
        System.out.println("Subtraction of a and b is : " +(a-b));
    }
    public void multiplication(int a , int b)                                                    //method to calculate multiplication
    {
        System.out.println("Multiplication  of a and b is : " +(a*b));
    }
    public void division(int a , int b)                                                         //method to calculate division
    {
        System.out.println("Division of a and b is : " +(a/b));
    }
    public void calculateResult(int a, int b, char symbol)                                    //method to calculate the result
    {
        if(symbol=='+')
        {
            addition(a,b);
